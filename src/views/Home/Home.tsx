...
const Home: React.FC = () => {
  return (
    <Page>
      ...
      {/* <StyledInfo>
        <b>MYFI Rewards start from block: <StyledLink target="_blank" href="https://etherscan.io/block/countdown/10849177">10849177</StyledLink></b>
        <p>If you can't see your BUSD LP Tokens, withdraw them from the previous contract (located at https://old.ymen.finance ) and then deposit them on the new contract on this page.</p>
